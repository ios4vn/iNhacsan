...
class DLDemoMenuViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if let hamburguerViewController = self.findHamburguerViewController() {
            hamburguerViewController.hideMenuViewControllerWithCompletion({ () -> Void in
                ...
                let contentvc = self.storyboard?.instantiateViewControllerWithIdentifier("vc3") as! UIViewController
                hamburguerViewController.contentViewController = contentvc
            })
        }
    ...
    func rootViewController() -> DLDemoRootViewController{
        return self.storyboard?.instantiateViewControllerWithIdentifier("DLDemoRootViewController") as! DLDemoRootViewController
    }
