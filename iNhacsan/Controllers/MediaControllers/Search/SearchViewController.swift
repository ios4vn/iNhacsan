...
class SearchViewController: BaseViewController {
    ...
    func setupSlideView(){
        let albumView = self.storyboard?.instantiateViewControllerWithIdentifier("albumList") as! AlbumListViewController
        ...
        let songView = self.storyboard?.instantiateViewControllerWithIdentifier("SongTop") as! SongListViewController
