...
class AlbumDetailViewController: BaseViewController {
    ...
    func setupSlideView(){
        let relateAlbums = self.storyboard?.instantiateViewControllerWithIdentifier("albumList") as! AlbumListViewController
        ...
        let albumDetail = self.storyboard?.instantiateViewControllerWithIdentifier("albumSongs") as! AlbumSongsViewController
